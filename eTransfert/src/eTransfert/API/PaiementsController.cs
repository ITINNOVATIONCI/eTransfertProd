...
namespace eTransfert.API
{
    ...
    public class PaiementsController : Controller
    {
        ...
        public PaiementsController(ApplicationDbContext dbContext)
        {
        ...
        public IEnumerable<Transactions> Get()
        {
            if (HttpContext.User.IsInRole("ADMIN"))
            {
                ...
                return _dbContext.Transactions.Where(c => c.TypeTransaction == "PAIEMENT").OrderByDescending(c =>c.DateTransaction).Take(10);
