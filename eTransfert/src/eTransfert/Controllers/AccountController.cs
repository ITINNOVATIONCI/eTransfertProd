    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "login ou mot de passe non valide.");
                    return View(model);
                }
            }
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> LoginMobile(LoginViewModel model)
        {
            //ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<IActionResult> LoginMobilePost(LoginViewModel model)
        {
            //ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> RegisterMobile(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                var u = HttpContext.User.GetUserId();
                var f = info.ExternalPrincipal;

                //Facebook.FacebookClient client = new Facebook.FacebookClient(f.Claims.FirstOrDefault().Value);

                //dynamic res = await client.GetTaskAsync("me");
                //var currentUser = new Facebook.FacebookClient.GraphUser(res);                

                //var user = await _userManager.FindByIdAsync(u);

                //var res = await _userManager.AddClaimAsync(user, f.Claims.FirstOrDefault());
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            var message = "Votre code de sécurité est : " + code;
